...
SECRET_KEY = "django-insecure-vxd#ivwyj7wdjd*p8#=-lxz#e26&=g_*-kl-f6-6@i3pyryv@2"
...
CSRF_TRUSTED_ORIGINS = ["http://localhost","http://127.0.0.1","http://http://paima-ishak-mentalhealthtracker1.pbp.cs.ui.ac.id", "https://http://paima-ishak-mentalhealthtracker1.pbp.cs.ui.ac.id"]
